...
final class TrackSelectionHelper implements View.OnClickListener, DialogInterface.OnClickListener {
  ...
  private View buildView(Context context) {
    ...
    disableView =
        (CheckedTextView) inflater.inflate(android.R.layout.simple_list_item_single_choice, root,
            false);
    ...
    for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
      ...
      for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
        ...
        trackView.setText(ExoUtils.buildTrackName(group.getFormat(trackIndex)));
    ...
    if (!haveSupportedTracks) {
      ...
      enableRandomAdaptationView =
          (CheckedTextView) inflater.inflate(android.R.layout.simple_list_item_multiple_choice,
              root, false);
